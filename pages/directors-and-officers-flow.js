                                                    ...
                                                    <>
                                                        {isEnterDetailsSecondActive ? (
                                                            <div className={`${form.entrDtlsFormSecond}`}>
                                                                ...
                                                                <Form>
                                                                    <Form.Group className={`selectDropDiv mb-4 ${!employeesValue == '' ? 'selectedDropDiv' : null}`}>
                                                                        <SelectSearch
                                                                            options={[
                                                                                {name: 'Upto 500', value: '1'},
                                                                                {name: 'Above 500', value: '2'},
                                                                            ]}
                                                                            name="employees"
                                                                            placeholder="&nbsp;"
                                                                    ...
                                                                    <Form.Group className="mb-4">
                                                                        <Form.Label htmlFor="existingPolicy" className={`${form.formLabel}`}>Do you have any existing D&O Policy?</Form.Label>
                                                                        <Form.Check
                                                                            inline
                                                                            type="radio"
                                                                            id="existingPolicy-1"
                                                            ...
                                                            <div className={`${form.entrDtlsFormThird}`}>
                                                                ...
                                                                <Form>
                                                                    ...
                                                                    <Form.Group className="mb-4">
                                                                        <Form.Label htmlFor="revenue" className={`${form.formLabel}`}>Is Net worth & Revenue of your Company Positive?</Form.Label>
                                                                        <Form.Check
                                                                            inline
                                                                            type="radio"
                                                                            id="revenue-1"
