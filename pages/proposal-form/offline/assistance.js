...
export default function ProposalFormOfflineAssistance() {
    ...
    return (
        <>
            <Head>
                <title>Assistance | Offline Proposal Form | Directors & Officers Insurance</title>
            ...
            <HeaderPlain
                ...
                talkExpertIcon="true"
            />
            <section className='proposalFormAssistanceBlock sectionPadding py-4 py-md-5'>
                <Container>
