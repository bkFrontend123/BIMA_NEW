...
export default function ProposalFormOffline() {
    ...
    const goToNextPage = () => {
        router.push('/proposal-form/end?mode=offline');
    };

    return (
        <>
            <Head>
                <title>Offline Proposal Form | Directors & Officers Insurance</title>
            ...
            <HeaderPlain
                ...
                talkExpertIcon="true"
            />
            <section className='proposalFormOfflineBlock sectionPadding py-4 py-md-5'>
                <Container>
