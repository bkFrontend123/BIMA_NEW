...
import productIcon from '../public/productIcons/liability/generalLiability_icon.svg'
...
export default function GeneralLiability_Flow() {
    ...
    const goToBackPage = () => {
        router.push('/general-liability-insurance');
    };
    const goToNextPage = () => {
                                                    ...
                                                    <>
                                                        {isEnterDetailsSecondActive ? (
                                                            <div className={`${form.entrDtlsFormSecond}`}>
                                                                ...
                                                                <Form>
                                                                    <Form.Group className={`selectDropDiv mb-4 ${!listedValue == '' ? 'selectedDropDiv' : null}`}>
                                                                        <SelectSearch
                                                                            options={[
                                                                                {name: 'Yes', value: '1'},
                                                                                {name: 'No', value: '2'},
                                                                            ...
                                                                            name="listed"
                                                                            placeholder="&nbsp;"
                                                                            onChange={setListedValue}
                                                                            value={listedValue}
                                                                        />
                                                                        <label>Are you Listed?</label>
                                                                    </Form.Group>
                                                                    <div className='mb-4'>
                                                                        <div className={`${form.formLabel}`}>Select the countries you have business locations in and the number of business locations each country have.</div>
                                                            ...
                                                            <>
                                                                {isEnterDetailsThirdActive ? (
                                                                    ...
                                                                    <div className={`${form.entrDtlsFormFourth}`}>
                                                                        ...
                                                                        <Form>
                                                                            <Form.Group className="mb-4">
                                                                                <Form.Label htmlFor="existingPolicy" className={`${form.formLabel}`}>Do you have any existing CGL Policy?</Form.Label>
                                                                                <Form.Check
                                                                                    inline
                                                                                    type="radio"
                                                                                    id="existingPolicy-1"
