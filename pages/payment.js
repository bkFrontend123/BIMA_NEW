...
import paymentTextImg from '@/public/proposalForm/paymentText.svg'
...
export default function Payment() {
    ...
    const goToNextPage = () => {
        router.push('/proposal-form?page=checkout');
    };
                            ...
                            <Row className='g-4 g-xl-5 justify-content-center'>
                                <Col lg={5}>
                                    <div className='text-center my-4 my-md-5'>
                                        <Image src={paymentTextImg} width={218} height={45} alt="Payment Image" />
                                    </div>
