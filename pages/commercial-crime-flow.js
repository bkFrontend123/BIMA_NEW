...
export default function CommercialCrime_Flow() {
    ...
    const [crimePolicyValue, setCrimePolicyValue] = useState();
    const handleChangeCrimePolicy = event => {
        setCrimePolicyValue(event.target.value);
    };
                                                                    ...
                                                                    <div className={`${form.entrDtlsFormThird}`}>
                                                                        ...
                                                                        <Form>
                                                                            <Form.Group className="mb-4">
                                                                                <Form.Label htmlFor="hazardousSubstances" className={`${form.formLabel}`}>Do you want to take Cyber Policy along with This crime policy?</Form.Label>
                                                                                <Form.Check
                                                                                    inline
                                                                                    type="radio"
                                                                                    id="crimePolicy-1"
